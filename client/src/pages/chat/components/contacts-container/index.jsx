import { GET_CONTACT_ROUTES } from "@/utils/constants";
    ...
    <div className="relative flex flex-col w-full md:w-[35vw] lg:w-[30vw] xl:w-[20vw] min-w-[260px] h-screen bg-[#13141c] border-r border-white/[0.06]">
      ...
      {activeTab === "group" && (
        <div className="flex flex-col flex-1 min-h-0 py-3">
          ...
          <div className="flex-1 overflow-y-auto contacts-scroll">
            <ContactList  contacts={[]} isChannel />
          </div>
        </div>
      )}
...
const Title = ({ text }) => (
  <h6 className="text-[10px] uppercase tracking-[0.15em] text-white/25 font-semibold">
    {text}
  </h6>
);